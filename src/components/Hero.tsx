      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-black mb-6 tracking-tight">
            <span className={theme === 'dark' ? 'text-white' : 'text-gray-800'}>{t('hero.title').split(' ')[0]}</span>{' '}
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-10">
            <Badge variant="secondary" className="px-4 py-2 text-sm font-semibold">
              ...
              <div>
                ...
                <div className="text-xs text-muted-foreground">{t('hero.badge1desc')}</div>
              </div>
            </Badge>
            <Badge variant="secondary" className="px-4 py-2 text-sm font-semibold">
              ...
              <div>
                ...
                <div className="text-xs text-muted-foreground">{t('hero.badge2desc')}</div>
              </div>
            </Badge>
            <Badge variant="secondary" className="px-4 py-2 text-sm font-semibold">
              ...
              <div>
                ...
                <div className="text-xs text-muted-foreground">{t('hero.badge3desc')}</div>
              </div>
            </Badge>
          </div>
